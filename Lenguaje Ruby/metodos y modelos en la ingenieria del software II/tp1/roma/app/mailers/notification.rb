...
JobVacancy::App.mailer :notification do
  ...
  email :recovery_code_email do |password_resetter|
    from 'Job Vacancy <no_reply@jobvacancy.com>'
    to password_resetter.user_email
    subject 'Password recovery code'
    locals code: password_resetter.code
    content_type :plain
    render 'notification/recovery_password_email'
  end
end
